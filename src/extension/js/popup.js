document.addEventListener("DOMContentLoaded", function () {
    ...
    function sendMessage(messageText) {
        ...
        chrome.storage.local.get(['token'], function (result) {
            ...
            formData.append('history', localStorage.getItem("chatHistory"));
            fetch(`http://127.0.0.1:8000/api/chat/`, {
                ...
                .then(data => {
                    ...
                    var his = localStorage.getItem("chatHistory");
                    var chatHistory;
                    if (his === null) {
                        chatHistory = localStorage.getItem("summariseChat");
                        if (chatHistory === null) {
                            chatHistory = '';
                        }
                    } else {
                        chatHistory = his.slice(-500);
                    }
                    chatHistory += ' ' + messageTextBot;
